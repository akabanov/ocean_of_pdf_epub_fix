...
import 'package:ocean_of_pdf_epub_fix/pwa_install/js_stub.dart'
...
enum LaunchMode {
  pwa(shortLabel: 'PWA', longLabel: 'Progressive Web App', installed: true),
  twa(shortLabel: 'TWA', longLabel: 'Trusted Web Activity', installed: true),
  browser(shortLabel: 'Browser', longLabel: 'Browser', installed: false);
